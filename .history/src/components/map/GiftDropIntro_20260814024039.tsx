...
// Dove — flock flying across a starry night sky over a pine forest.
// Two forest layers (near dark, far dim) parallax slowly so the flock
// reads as gliding over real trees. Fog rolls between the layers to
// sell depth.
...
//       {/* Stars — 180 twinkling across the whole sky */}
//       {stars.map((s, i) => (
//         <motion.div
//           key={`star-${i}`}
...
//       {/* Forest below — 3-layer parallax silhouette (far → near) */}
//       <ForestSilhouette />
//     </>
//   );
// }
