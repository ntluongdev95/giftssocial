...
function buildVehicleSvg(kind: VehicleKind, kissId: string): string {
  ...
  switch (kind) {
    ...
    case 'car': {
  // Deterministic supercar selection:
  // the same gift always gets the same supercar.
  const carIndex = id
  ...
  return `
    ...
    >
      ...
      >
        ...
        <!-- Side air intakes -->
        <path
          d="M15 31 L23 30 L20 35 L14 36Z"
          fill="${car.dark}"
          opacity="0.9"
        />

        <path
          d="M49 31 L41 30 L44 35 L50 36Z"
          fill="${car.dark}"
          opacity="0.9"
        />
        ...
        <!-- Headlights -->
        <path
          d="M16 26 L24 24 L21 29 L16 30Z"
          fill="url(#supercarLight-${id})"
        />

        <path
          d="M48 26 L40 24 L43 29 L48 30Z"
          fill="url(#supercarLight-${id})"
        />
