...
function buildVehicleSvg(kind: VehicleKind, kissId: string): string {
  ...
  switch (kind) {
    ...
    case 'car': {
  // Premium supercar fleet. Selection is deterministic so a gift keeps
  // the same car across re-renders without using random state.
  const n = Array.from(kissId).reduce((sum, c) => sum + c.charCodeAt(0), 0) % 3;

  const specs = [
    {
      name: 'Porsche-inspired 911',
      paint: '#c1121f',
      paint2: '#6f0b12',
      glass: '#07111f',
      light: '#fff7ed',
  ...
  const uid =
    kissId.replace(/[^a-zA-Z0-9_-]/g, '').slice(0, 8) || 'car';
  ...
  >
    ...
    <!-- Front / rear tires -->
    <path
      d="M13 15 Q8 17 9 25 L10 31 Q11 35 16 35 L20 34 L20 14Z"
      fill="#030712"
    />

    <path
      d="M76 14 L80 14 Q85 16 86 23 L86 30 Q85 34 80 35 L75 34Z"
      fill="#030712"
    />

    <path
      d="M17 39 L21 38 L21 51 L17 52 Q12 50 12 45 Q12 41 17 39Z"
      fill="#030712"
    />

    <path
      d="M75 38 L80 39 Q84 41 84 45 Q84 50 79 52 L75 51Z"
      fill="#030712"
    />

    <!-- Low wide supercar body -->
    <path
      d="
        M9 29
        C13 25 19 23 27 21
    ...
    <!-- Headlights -->
    <path
      d="M12 30 L29 26 L25 32 L13 35Z"
      fill="url(#sc-light-${uid})"
    />

    <path
      d="M84 30 L68 26 L72 32 L83 35Z"
      fill="url(#sc-light-${uid})"
    />
